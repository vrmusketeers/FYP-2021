...
MODEL_PATH = 'gs://tm_fmri_model_storage/lstm'
ATLAS_PATH = "/atlas/"

class LSTMPredictor(object):
    def __init__(self):
        lstm, masker, smith_atlas = self.from_path()
        self.lstm,self.masker, self.smith_atlas = lstm, masker, smith_atlas
    ...
    def predict(self, func_file, **kwargs):
        ...
        y_pred = self.lstm.predict(np.array(subject_data))
