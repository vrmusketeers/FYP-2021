...
root_folder = '/content/drive/MyDrive/Colab Notebooks/Project/gcn_data/'
...
shutil.copyfile('/content/population-gcn/subject_IDs.txt', os.path.join(data_folder, 'subject_IDs.txt'))
