...
code_folder = "/content/drive/MyDrive/Colab Notebooks/Project/abide_sta/"
root_folder = '/content/drive/MyDrive/Colab Notebooks/Project/abide_sta/data'
data_folder = os.path.join(root_folder, 'ABIDE_pcp/cpac/filt_noglobal/')
if not os.path.exists(data_folder):
    os.makedirs(data_folder)
shutil.copyfile(os.path.join(root_folder,'subject_IDs.txt'), os.path.join(data_folder, 'subject_IDs.txt'))
